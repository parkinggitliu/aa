...
thru_file = "./C2M__Z100_IL14_WC_BOR_H_L_H_THRU.s4p"
...
sdp.channel_coefficients(pulse_response, t, samples_per_symbol, 3, 20, res=100)

#crop impulse response and save
plt.figure(dpi = 100)
h_thru_crop = h_thru[44500:47500]
plt.plot(h_thru_crop)
plt.title("h_thru 44500:47500")
...
#save data
np.save("./data/h_thru.npy",h_thru)
